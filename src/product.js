...
const productsArea = document.querySelector(".productArea");
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="product mb-0">
                <div class="product-thumb-info border-0 mb-3">
                    <div class="product-thumb-info-badges-wrapper"><span class="badge badge-ecommerce badge-success">${item.badge.new}</span>
                    <span class="badge badge-ecommerce badge-danger">${item.badge.offer}</span>
                    </div>
                ...
                <p class="price text-5 mb-3">
                    <span class="sale text-color-dark font-weight-semi-bold"> ${item.sellPrice} </span>
                    <span class="amount"> ${item.regularPrice} </span>
                </p>
            </div>
        </div>
    `;
...
productsArea.innerHTML = prouctlist;